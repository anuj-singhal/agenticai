...
class MCPAgent:
    ...
    def __init__(self, openai_api_key: str, server_configs: List[Dict[str, Any]]):
        ...
        self.openai_client = openai.AsyncOpenAI(base_url="http://localhost:11434/v1", api_key=openai_api_key)
    ...
    try:
        ...
        while True:
            try:
                ...
                result = await agent.execute_task(task, use_openai_tool_calling=True)
                print(f"\nTask: {result['task']}")
                ...
                if 'evaluation' in result:
                    ...
                    print(f"Task Completed: {result['evaluation'].get('task_completed', 'N/A')}")
